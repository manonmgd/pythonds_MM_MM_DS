# On scrap le top 2023 de livraddict par genre
...
if response.status_code == 200:  # Vérifie que le site autorise le scraping
    ...
    for category in categories:
        ...
        for book in books:
            ...
            # On ajoute les informations à la liste qu'on a crée
            if title and author:
